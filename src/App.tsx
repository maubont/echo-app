...
import { PitchLandingPage } from './features/pitch/PitchLandingPage';

const App = () => {
    // Version Log for Deployment Verification
    console.log('🚀 Echo Pulse v1.3.0 - Loaded (Pitch Landing + AI Agent)');
        ...
        <Router>
            <ThemeProvider>
                <AuthProvider>
                    <PresenceProvider>
                        <Routes>
                            {/* Public Pitch Landing — full-width, no mobile shell */}
